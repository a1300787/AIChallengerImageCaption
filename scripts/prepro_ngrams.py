...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='/home/hc/image2txt/chinese_im2text.pytorch/data/hc_ai_challenger/coco_ai_challenger.json', help='input json file to process into hdf5')
  parser.add_argument('--dict_json', default='/home/hc/image_root/ai_challenger/coco_ai_challenger_talk.json', help='output json file')
  parser.add_argument('--output_pkl', default='/home/hc/image_root/ai_challenger/cooc-train', help='output pickle file')
